...
st.set_page_config(page_title="NCERT Bot by Rayyan Khan", layout="wide")
...
- _"Explain function of Judiciary from PoliticalScience**."_  

                

### ❌ Poor Query Example:
- _"Explain **nationalism**."_  
- _"Explain Democracy from *Politcal Science* .Correct is **PoliticalScience**."_  
